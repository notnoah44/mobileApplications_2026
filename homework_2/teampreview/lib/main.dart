...
class _TeamScreenState extends State<TeamScreen> {
  ...
  final List<TeamMember> members = [
    TeamMember(
      ...
      homeCountry: "Germany, THWS",
      role: "Lead Developer",
      hobbies: ["Coding", "Hiking", "Gaming"],
    ),
    TeamMember(
      firstName: "Florian Jafar Sabonchi",
    ...
    TeamMember(
      firstName: "Prashantha Kumanayake",
